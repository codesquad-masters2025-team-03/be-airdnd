...
VALUES ('부산광역시', '수영구', '수영로 533', ST_GeomFromText('POINT(35.157 129.113)', 4326)),
       ...
       ('경상남도', '창원시 마산회원구', '회원동 123', ST_GeomFromText('POINT(35.2274 128.5725)', 4326)),
       ('경상남도', '창원시 마산합포구', '중앙동 456', ST_GeomFromText('POINT(35.1903 128.5721)', 4326)),
       ('경상남도', '창원시 의창구', '팔용동 789', ST_GeomFromText('POINT(35.2672 128.6269)', 4326)),
       ('경상남도', '창원시 성산구', '상남동 101', ST_GeomFromText('POINT(35.2191 128.6812)', 4326)),
       ('경상남도', '창원시 진해구', '충무동 202', ST_GeomFromText('POINT(35.1478 128.7094)', 4326));
...
VALUES (1, 3, 1, '2025-06-25', '2025-06-29', 3, 'PENDING', 400000),
       ...
       (25, 7, 45, '2025-06-24', '2025-06-25', 1, 'PENDING', 120000);   -- 진해구
