...
VALUES (1, '숙소 1', 'Fugiat ab vitae temporibus.', 250000, 3, 3, 1, 1, 2, 2, '2025-06-17 04:03:06'),
       ...
       (41, '창원 마산회원구 숙소', '회원구 조용한 주택가 숙소', 130000, 3, 2, 1, 1, 41, 6, NOW()),
       (42, '창원 마산합포구 숙소', '합포구 바닷가 근처 숙소', 160000, 4, 3, 2, 1, 42, 6, NOW()),
       (43, '창원 의창구 숙소', '의창구 신도시 내 숙소', 140000, 3, 1, 1, 1, 43, 6, NOW()),
       (44, '창원 성산구 숙소', '성산구 중심 상권 근처 숙소', 170000, 5, 3, 2, 2, 44, 6, NOW()),
       (45, '창원 진해구 숙소', '진해구 벚꽃명소 옆 숙소', 120000, 3, 1, 1, 1, 45, 6, NOW());
