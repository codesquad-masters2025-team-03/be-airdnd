...
VALUES (1, 'ggim@dreamwiz.com', '안성민', 'user01', 'pw7311', 'GUEST', '063-593-8242', 'https://dummyimage.com/194x513',
       ...
       (8, 'ggsdgim@dreamwiz.com', '김현준', 'user08', 'pw2553', 'GUEST', '043-457-9230',
        'https://placekitten.com/324/331',
        '2025-06-17 04:03:06'),
...
INSERT INTO accommodation (id, name, description, price_per_night, max_guests, bed_count, address_id, host_id,
                           created_at)
VALUES (1, '숙소 1', 'Fugiat ab vitae temporibus.', 250000, 3, 3, 2, 2, '2025-06-17 04:03:06'),
       (2, '숙소 2', 'At libero vero molestiae illo odio accusantium.', 250000, 4, 3, 3, 3, '2025-06-17 04:03:06'),
       (3, '숙소 3', 'Ipsam quia explicabo sit perferendis deserunt.', 200000, 6, 3, 4, 4, '2025-06-17 04:03:06'),
       (4, '숙소 4', 'Occaecati minus illum odio illo quod ratione.', 150000, 5, 1, 5, 5, '2025-06-17 04:03:06'),
       (5, '숙소 5', 'Ab aliquam nulla voluptatum sit praesentium.', 120000, 2, 1, 6, 6, '2025-06-17 04:03:06'),
       (6, '숙소 6', 'Cumque in tempore ipsa ipsum quae.', 120000, 3, 1, 7, 7, '2025-06-17 04:03:06'),
       (7, '숙소 7', 'Recusandae ipsa dignissimos quae temporibus.', 80000, 1, 1, 8, 8, '2025-06-17 04:03:06'),
       (8, '숙소 8', 'Quia perspiciatis doloremque error.', 250000, 6, 3, 9, 9, '2025-06-17 04:03:06'),
       (9, '숙소 9', 'Illum amet possimus pariatur officiis molestias.', 80000, 6, 1, 10, 10, '2025-06-17 04:03:06'),
       (10, '숙소 10', 'Expedita enim ab aperiam.', 80000, 3, 1, 11, 11, '2025-06-17 04:03:06'),
       (11, '숙소 11', 'Non assumenda eum modi.', 120000, 2, 3, 12, 12, '2025-06-17 04:03:06'),
       (12, '숙소 12', 'Dolorum quas error maxime harum.', 120000, 6, 1, 13, 13, '2025-06-17 04:03:06'),
       (13, '숙소 13', 'Totam impedit laudantium.', 250000, 1, 2, 14, 14, '2025-06-17 04:03:06'),
       (14, '숙소 14', 'Nostrum repellendus nam suscipit hic vero.', 80000, 6, 2, 15, 15, '2025-06-17 04:03:06'),
       (15, '숙소 15', 'Autem tempore nostrum ratione quae quod.', 120000, 1, 3, 16, 16, '2025-06-17 04:03:06'),
       (16, '숙소 16', 'Dolorum eligendi quasi optio quia maiores.', 250000, 1, 3, 17, 17, '2025-06-17 04:03:06'),
       (17, '숙소 17', 'Consequatur dignissimos totam libero.', 150000, 3, 3, 18, 18, '2025-06-17 04:03:06'),
       (18, '숙소 18', 'Occaecati tempore autem rerum.', 120000, 1, 3, 19, 19, '2025-06-17 04:03:06'),
       (19, '숙소 19', 'Fugit animi alias quas vitae.', 150000, 5, 2, 20, 20, '2025-06-17 04:03:06'),
       (20, '숙소 20', 'Explicabo molestiae quasi.', 120000, 1, 2, 1, 1, '2025-06-17 04:03:06'),
       (21, '부산 숙소 1', '뷰 좋은 숙소', 100000, 2, 1, 21, 6, NOW()),
       (22, '부산 숙소 2', '해운대 앞 숙소', 110000, 3, 2, 22, 6, NOW()),
       (23, '부산 숙소 3', '감성 숙소', 120000, 4, 2, 23, 6, NOW()),
       (24, '부산 숙소 4', '럭셔리 숙소', 130000, 5, 3, 24, 6, NOW()),
       (25, '부산 숙소 5', '깔끔한 숙소', 140000, 2, 2, 25, 6, NOW()),
       (26, '부산 숙소 6', '가성비 숙소', 150000, 6, 3, 26, 6, NOW()),
       (27, '부산 숙소 7', '주방 완비 숙소', 160000, 3, 2, 27, 6, NOW()),
       (28, '부산 숙소 8', '신축 숙소', 170000, 4, 2, 28, 6, NOW()),
       (29, '부산 숙소 9', '모던 숙소', 180000, 5, 3, 29, 6, NOW()),
       (30, '부산 숙소 10', '지하철 근처 숙소', 190000, 2, 1, 30, 6, NOW()),
       (31, '히스토그램 숙소 1', '테스트용 숙소입니다.', 150000, 4, 2, 31, 6, NOW()),
       (32, '히스토그램 숙소 2', '테스트용 숙소입니다.', 150000, 4, 2, 32, 6, NOW()),
       (33, '히스토그램 숙소 3', '테스트용 숙소입니다.', 150000, 4, 2, 33, 6, NOW()),
       (34, '히스토그램 숙소 4', '테스트용 숙소입니다.', 150000, 4, 2, 34, 6, NOW()),
       (35, '히스토그램 숙소 5', '테스트용 숙소입니다.', 150000, 4, 2, 35, 6, NOW()),
       (36, '히스토그램 숙소 6', '테스트용 숙소입니다.', 150000, 4, 2, 36, 6, NOW()),
       (37, '히스토그램 숙소 7', '테스트용 숙소입니다.', 150000, 4, 2, 37, 6, NOW()),
       (38, '히스토그램 숙소 8', '테스트용 숙소입니다.', 150000, 4, 2, 38, 6, NOW()),
       (39, '히스토그램 숙소 9', '테스트용 숙소입니다.', 150000, 4, 2, 39, 6, NOW()),
       (40, '히스토그램 숙소 10', '테스트용 숙소입니다.', 150000, 4, 2, 40, 6, NOW());
...
-- 기존 데이터 로딩 이후, 각 숙소에 이미지 1개씩 저장
INSERT INTO stored_file (file_url, file_order, target_type, target_id)
VALUES ('https://example.com/accommodation1.jpg', 1, 'ACCOMMODATION', 1),
       ('https://example.com/accommodation2.jpg', 1, 'ACCOMMODATION', 2),
       ('https://example.com/accommodation3.jpg', 1, 'ACCOMMODATION', 3),
       ('https://example.com/accommodation4.jpg', 1, 'ACCOMMODATION', 4),
       ('https://example.com/accommodation5.jpg', 1, 'ACCOMMODATION', 5),
       ('https://example.com/accommodation6.jpg', 1, 'ACCOMMODATION', 6),
       ('https://example.com/accommodation7.jpg', 1, 'ACCOMMODATION', 7),
       ('https://example.com/accommodation8.jpg', 1, 'ACCOMMODATION', 8),
       ('https://example.com/accommodation9.jpg', 1, 'ACCOMMODATION', 9),
       ('https://example.com/accommodation10.jpg', 1, 'ACCOMMODATION', 10),
       ('https://example.com/accommodation11.jpg', 1, 'ACCOMMODATION', 11),
       ('https://example.com/accommodation12.jpg', 1, 'ACCOMMODATION', 12),
       ('https://example.com/accommodation13.jpg', 1, 'ACCOMMODATION', 13),
       ('https://example.com/accommodation14.jpg', 1, 'ACCOMMODATION', 14),
       ('https://example.com/accommodation15.jpg', 1, 'ACCOMMODATION', 15),
       ('https://example.com/accommodation16.jpg', 1, 'ACCOMMODATION', 16),
       ('https://example.com/accommodation17.jpg', 1, 'ACCOMMODATION', 17),
       ('https://example.com/accommodation18.jpg', 1, 'ACCOMMODATION', 18),
       ('https://example.com/accommodation19.jpg', 1, 'ACCOMMODATION', 19),
       ('https://example.com/accommodation20.jpg', 1, 'ACCOMMODATION', 20),
       ('https://example.com/accommodation21.jpg', 1, 'ACCOMMODATION', 21),
       ('https://example.com/accommodation22.jpg', 1, 'ACCOMMODATION', 22),
       ('https://example.com/accommodation23.jpg', 1, 'ACCOMMODATION', 23),
       ('https://example.com/accommodation24.jpg', 1, 'ACCOMMODATION', 24),
       ('https://example.com/accommodation25.jpg', 1, 'ACCOMMODATION', 25),
       ('https://example.com/accommodation26.jpg', 1, 'ACCOMMODATION', 26),
       ('https://example.com/accommodation27.jpg', 1, 'ACCOMMODATION', 27),
       ('https://example.com/accommodation28.jpg', 1, 'ACCOMMODATION', 28),
       ('https://example.com/accommodation29.jpg', 1, 'ACCOMMODATION', 29),
       ('https://example.com/accommodation30.jpg', 1, 'ACCOMMODATION', 30),
       ('https://example.com/accommodation31.jpg', 1, 'ACCOMMODATION', 31),
       ('https://example.com/accommodation32.jpg', 1, 'ACCOMMODATION', 32),
       ('https://example.com/accommodation33.jpg', 1, 'ACCOMMODATION', 33),
       ('https://example.com/accommodation34.jpg', 1, 'ACCOMMODATION', 34),
       ('https://example.com/accommodation35.jpg', 1, 'ACCOMMODATION', 35),
       ('https://example.com/accommodation36.jpg', 1, 'ACCOMMODATION', 36),
       ('https://example.com/accommodation37.jpg', 1, 'ACCOMMODATION', 37),
       ('https://example.com/accommodation38.jpg', 1, 'ACCOMMODATION', 38),
       ('https://example.com/accommodation39.jpg', 1, 'ACCOMMODATION', 39),
       ('https://example.com/accommodation40.jpg', 1, 'ACCOMMODATION', 40);
